...
#if 1       // remuxing, MP4 to FLV
int remuxing(char *srcPath, char *dstPath)
{
    AVOutputFormat *ofmt = NULL;
    AVFormatContext *ifmt_ctx = NULL, *ofmt_ctx = NULL;
    AVPacket pkt;
    ...
    if ((ret = avformat_open_input(&ifmt_ctx, srcPath, 0, 0)) < 0) {
        fprintf(stderr, "Could not open input file '%s'", srcPath);
        goto end;
    }
